							...
							<tr>
								...
								<td>
									<div class="container-fluid btn-group" role="group" >
										<button class="btn btn-success" onclick="window.location.href='/ismac-spring-libreria-web/clientes/findOne?idCliente=${item.idCliente}&opcion=1'; return false;">
											<i class="fa-solid fa-rotate-left">
											<!-- Actualizar -->
											</i>																			
										</button>
										<button class="btn btn-danger" onclick="window.location.href='/ismac-spring-libreria-web/clientes/findOne?idCliente=${item.idCliente}&opcion=2'; return false;">
